	...
	glPushMatrix();
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glRotatef(girod, 0.0, 1.0, 0.0);
				llanta.GLrender(NULL,_SHADED,1.0);//Rueda delantera derecha
				glPopMatrix();
				...
				glRotatef(girod, 0.0, 1.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);//delantera izquierda
				glPopMatrix();
				...
				glRotatef(giro_llanta, 1.0, 0.0, 0.0);
				glRotatef(girod, 0.0, 1.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);//trasera derecha
				glPopMatrix();
				...
				glRotatef(180, 0.0, 1.0, 0.0);
				glRotatef(girod, 0.0, 1.0, 0.0);
				llanta.GLrender(NULL, _SHADED, 1.0);//trasera izquierda
				glPopMatrix();
			glPopMatrix();
