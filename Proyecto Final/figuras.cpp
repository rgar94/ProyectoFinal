...
void CFiguras::prisma6(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(0.0f, 0.5f); glVertex3fv(vertice[4]);
	glTexCoord2f(10.0f, 0.5f); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(10.0f, 0.5f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 0.5f); glVertex3fv(vertice[4]);
	glEnd();
...
void CFiguras::triangulo(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
